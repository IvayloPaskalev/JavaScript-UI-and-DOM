...
gsmTemplateHTML = document.getElementById('superhero-list').innerHTML;

gsmTemplate = Handlebars.compile(gsmTemplateHTML);

document.getElementsByTagName('container')[0].innerHTML = gsmTemplate(data);
